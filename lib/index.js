...
var methods = ['configure', 'connect', 'console', 'check', 'create', 'deploy', 'dump', 'exec', 'get', 'init', 'install', 'kill', 'log', 'map', 'read', 'replace', 'set', 'start', 'status', 'uninstall', 'watch', 'write', 'zsh'];
