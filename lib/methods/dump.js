...
function getDumpProjectBoilerplateCommand() {
  ...
  return project.config.templateNames.map(function (templateName) {
    ...
    var totalExcludedDirs = (templateConfig.excludedDirs || []).concat(['package.json', '.gitignore', 'README.md', configFile, '\'_p_*\'']);
