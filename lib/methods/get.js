...
function getAvailablePorts(docker) {
  ...
  this.checkWeb();
  var activateDir = _path2.default.join(project.config.venv, 'bin/activate');
  var command = 'source ' + activateDir + ' && python ' + app.pythonDir + ' ports --filter available --docker ' + docker;
