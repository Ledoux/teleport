...
function setDockerEnvironment() {
  ...
  var docker = this.docker = this.backend.helpersByName.docker;
...
function setBaseEnvironment() {
  ...
  var base = this.base = this.docker.imagesByName.base;
}
...
function setCurrentEnvironment() {
  ...
  if (!docker || typeof docker.imagesByName === 'undefined') return;
  var current = this.current = this.docker.imagesByName.current;
...
function setMaintainerEnvironment() {
  ...
  if (!current) return;
  var maintainer = this.maintainer = this.current.maintainer;
}
...
function setRegistryEnvironment() {
  ...
  if (!docker) return;
  var registry = this.registry = this.docker.registry;
}
...
function setKubernetesEnvironment() {
  ...
  if (!backend || typeof this.backend.helpersByName === 'undefined') return;
  var kubernetes = this.kubernetes = this.backend.helpersByName.kubernetes;
}
